...
<body>
  ...
  <header id="header" class="fixed-top  header-transparent ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html">ONLINE-EBMS</a></h1>
    ...
    <div class="container">
      <div class="row">
        <div
          ...
          data-aos="fade-up">
          <div>
            <h1>Welcome to ONLINE-EBMS-Online Electricity Bill Management System</h1>
            <h2>ONLINE-EBMS is an online system to manage electricity billing for the administrator and customer.
            </h2>
        ...
        <div class="col-lg-6 d-lg-flex flex-lg-column align-items-stretch order-1 order-lg-2 hero-img"
          data-aos="fade-up">
          <img src="assets/img/Electricity-bg-3.gif" class="img-fluid" alt="">
        </div>
      </div>
    </div>
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="row content">
          ...
          <div class="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
            ...
            <p>
              User has to upload a clear image of the electricity meter for the relevant month before the
              deadlines to avoid
              extra charges.
            ...
            <p>
              Users can get to know about their electricity usages relevant to the month so that they can plan
              their power
              consumption and delay in payments process problem also will be solved through the system.
            </p>
          </div>
        </div>
      </div>
    ...
    <section id="pricing" class="pricing">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Stats</h2>
          <p>Electricity Bill management administrators can log into the systems through below links</p>
        </div>
