    ...
    <div class="col-lg-12 p-4 pt-12" style="background-color: #E5E4E2;">
        <div class="row gutters-sm">
                                                ...
                                                <form action="Form-Approved.php?user_id=<?php echo $data['user_id']?>"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="category" name="category" class="form-control">
                                                            ...
                                                            <option value="Industrial 1">Commercial</option>
            ...
            <?php
                ...
                if($data_img['status'] ?? null == 'Pending'){
                    ?>
            <div class="col-md-4">
                <div class="card border shadow-lg mb-4 p-2">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="px-3 needs-validation" method="POST"
                                                        ...
                                                        <div class="form-group">
                                                            <label>Charge for Electricity Consumed (BDT.)</label>
            ...
            <?php
                ...
                else if($data_img['status'] ?? null == 'Prepared'){
                    ?>
            <div class="col-md-4">
                <div class="card border shadow-lg mb-4 p-2">
                    <h2 class="text-center">Registered Form</h2>
                ...
                <div class="card border shadow-lg mb-3">
                    ...
                    <div class="px-3 needs-validation">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-10 p-2">
                                <br>
                                <h4 style="text-align: center;">Bangladesh Electricity
                ...
                <div class="card-body">
                    ...
                    ?>
                            <tr style="text-align: center;">
                                ...
                                <td><?php echo $data_one_pay['pay_name']; ?></td>
                                <td style="text-align: center;"><a
                                        href="Download-Month.php?user_id=<?php echo urlencode($data_image_month['user_id'] ?? null ); ?>&month=<?php echo urlencode($results_month_bill); ?>"><?php $data_image_month['filename'] ?? null;?><i
                                            class="fa fa-download"></i></a></td>
                                <td style="text-align: center;">
                                    <button class="btn btn-dark" data-bs-toggle="modal"
