        ...
        if (empty($username_err) && empty($email_err) && empty($nic_err) && empty($contact_err) && empty($password_err) && empty($confirm_password_err)) {
            ...
            if ($stmt = $link->prepare($sql)) {
                ...
                if ($stmt->execute()) {
                    ...
                    echo "<script>window.location.href = 'User-Added.php';</script>";
                    exit();
                } else {
        ...
        if (empty($name_err) && empty($address_err) && empty($area_err) && empty($premises_err) && empty($acc_err)) {
            ...
            if ($stmt = $link->prepare($sql)) {
                ...
                if ($stmt->execute()) {
                    ...
                    echo "<script>window.location.href = 'User-Registered.php';</script>";
                                            ...
                                            <div class="modal-body">
                                                <form
                                                    ...
                                                    <div class="row gutters-sm">
                                                        ...
                                                        <div class="form-group col-md-6" style="text-align: left;">
                                                            <label style="font-weight: normal;font-size: 18px;">NID
                                                                Number</label>
                                                            <input type="text" class="form-control" name="user_nic"
                                                                placeholder="Enter the NID Number" required>
