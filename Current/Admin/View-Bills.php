    ...
    <div class="col-lg-8 bg-white p-4">
        ...
        <div class="table-responsive-sm">
            <table class="table table-striped table-hover" style="font-size: 14px;" id="myTable">
                ...
                <?php
            $db = mysqli_connect("localhost","root","","electricity_water");
            ...
            while($data_bill=mysqli_fetch_assoc($records_bill)){
                ...
                <tr>
                    ...
                    echo $data_img['month'] ?? null;
                    ?>
                    </td>
                    <td><i class="fa fa-file-image-o" aria-hidden="true"></i>&nbsp;<?php echo $data_img['filename'] ?? null;?>
                    </td>
                    <td style="text-align: center;"><a
                            href="Download-Month.php?user_id=<?php echo urlencode($data_img['user_id'] ?? null); ?>&month=<?php echo urlencode($bill_month) ?>"><?php $data_img['filename'] ?? null;?><i
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="px-3 needs-validation">
                                        ...
                                        <div class="form-group">
                                            <label><?php $charge = 'Charge for the month' ?>Charge For the Month(BDT.)</label>
                                            <input type="text" class="form-control"
                                                value="<?php echo $data_bill['charge'] ?>" disabled>
                                        </div><br>

                                        <div class="form-group">
                                            <label><?php $total = 'Total Amount' ?>Total Amount Due (BDT.)</label>
                                            <input type="text" class="form-control"
