...
{
    $db = new mysqli('localhost', 'root', '', 'electricity_water');
...
function imageUploaded()
{
    ...
    $bill_month = $data_month['month'] ?? null;
    ...
    <div class="col-lg-12 p-4 pt-12">
            ...
            <div class="col-md-8">
                <div class="col-md-14">
                    <div class="card border  mb-3 p-2">
                        ...
                        <div class="card-body">
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] ?? null); ?>" method="POST" enctype="multipart/form-data">
                                <?php
                                $sql_month = "SELECT * FROM bill_month";
                                $records_month = mysqli_query($link, $sql_month);
                                $data_month = mysqli_fetch_assoc($records_month);
                                $admin_id = $data_month['admin_id'] ?? null;
                                ...
                                $month = $data_month['month'] ?? null;
                                ?>
                                <div class="row gutters-sm">
                                    <div class="form-group col-md-4">
                                        <label>Billing Month</label>
                                        <input type="month" class="form-control" name="month" required value="<?php echo $data_month['month'] ?? null ?>">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Updated By</label>
                                        <input disabled type="text" class="form-control" value="<?php echo $data_admin['admin_username'] ?? null ?>">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Updated At</label>
                                        <input disabled type="text" class="form-control" value="<?php echo $data_month['updated_at'] ?? null ?>">
                                    </div>
                                </div><br>
                                ...
                                <div class="table-responsive-sm">
                                    <table class="table table-striped table-hover" style="text-align: center;">
                                        <thead style="font-weight: bold;">
                                            <tr>
                                                <th> Consumption</th>
                                                <th>Charge<br>(BDT/units)</th>
                                                <th>Fixed Charge<br>(BDT/month)</th>
                                            </tr>
                                        </thead>
                                        <tr>
                                            <td>0-30</td>
        ...
        <div class="col-md-14">
            <div class="card border mb-3 p-2">
                <div class="row gutters-sm">
                    <h2 class="align-items-center text-center">
                        Commercial&nbsp;<i class="fa fa-industry" aria-hidden="true"></i>
                    </h2>
                    <div class="col-md-6">
                        <div class="card border mb-3 p-2">
                                ...
                                <table class="table table-striped table-hover" style="text-align: center;">
                                    <thead style="font-weight: bold;">
                                        <tr>
                                            <th>Consumption</th>
                                            <th>Charge<br>(BDT/units)</th>
                                            <th>Fixed<br>Charge<br>(BDT/month)</th>
                                            <th>Max<br>Demand<br>Charge<br>(BDT/kVA)</th>
                                        </tr>
                                    </thead>
                                    <tr>
                                        <td>1-1</td>
                            ...
                            <table class="table table-striped table-hover" style="text-align: center;">
                                <thead style="font-weight: bold;">
                                    <tr>
                                        ...
                                        <th>Charge<br>(BDT/units)</th>
                                        <th>Fixed Charge<br>(BDT/month)</th>
                                        <th>Max Demand Charge<br>(BDT/kVA)</th>
                                    </tr>
                                </thead>
                                <tr>
                                    <td>H-1</td>
