...
$due_month = $data_month['month'] ?? null;
        ...
        <div class="row gutters-sm">
            ...
            <div class=" col-md-5 mb-3"><br>
                <div class="card border shadow-lg p-2">
                    <?php
                    if($one_bill['status'] ?? null == 'Not Paid'){
                        ?>
                    <h2 class="align-items-center text-center">Online Payment</h2>
                    <div class="card-body">
                        <p>*Fill required information of the person who is paying.</p>
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] ?? null ); ?>" method="POST"
                            id="payment-form">
                            <div class="form-group">
                                <label>Bill Owner Name</label>
                                <input type="text" class="form-control" value="<?php echo $data_method['name'] ?? null; ?>"
                                    disabled>
                            </div>

                            <div class="form-group">
                                <label>User Account Name</label>
                                <input type="text" class="form-control" value="<?php echo $data_user['user_name'] ?? null; ?>"
                                    disabled>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="user_email"
                                        value="<?php echo $data_user['user_email'] ?? null ;?>" disabled>
                                </div>
                            </div>
                    ...
                    <?php
                        ...
                        ?>
                    <h2 class="align-items-center text-center">Online Payment for <?php echo $bill_pay['month'] ?? null ?></h2>
                    <div class="card-body">
                        <div class="alert alert-success" role="alert">
                            <h5 class="align-items-center text-center">Bill Payment is Done&nbsp;<i
                                    class="fa fa-check-circle-o" aria-hidden="true"></i></h5>
                            You have paid the bill for <?php echo $bill_pay['month'] ?? null  ?>.
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" class="form-control" value="<?php echo $bill_pay['pay_name'] ?? null ?>"
                                    disabled>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label>NID Number</label>
                                    <input type="text" class="form-control" value="<?php echo $bill_pay['pay_nic']?? null?>"
                                        disabled>
                                </div>
                            ...
                            <div class="form-group">
                                <label>Amount(BDT.)</label>
                                <input type="text" class="form-control" value="<?php echo $bill_pay['pay_amount'] ?? null ?>"
                                    disabled>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card border shadow-lg mb-3 p-2">
                    ...
                    <div class="card-body">
                        <div class="px-3 needs-validation">
                            <div class="form-row">
                                <diV class="form-group col-md-2"><img src="../../images/ebd-logo.jpeg"></diV>
                                <div class="form-group col-md-10 p-2">
                                    <br>
                                    <h4 style="text-align: center;">Bangladesh Electricity Board Statement of Electricity
                                        Account<h4>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"
                                    value="<?php echo $data_method['user_address'] ?? null ?>" disabled>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label>Electricity Account Number</label>
                                    <input type="text" class="form-control"
                                        value="<?php echo $data_method['user_account'] ?? null ?>" disabled>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>Category</label>
                                    <input type="text" class="form-control"
                                        value="<?php echo $data_method['category'] ?? null ?>" disabled>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label>Meter Reading</label>
                                    <input type="text" class="form-control" value="<?php echo $one_bill['meter'] ?? null ?>"
                                        disabled>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $one_bill['units'] ?? null ?>"
                                        disabled>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label>Charge for Electricity Consumed (BDT.) For the Month</label>
                                    <input type="text" class="form-control" value="<?php echo $one_bill['charge'] ??null ?>"
                                        disabled>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>Total Amount Due (BDT.)</label>
                                    <input type="text" class="form-control" value="<?php echo $one_bill['total'] ?? null ?>"
                                        disabled>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label>Updated</label>
                                    <input type="text" class="form-control" value="<?php echo $one_bill['updated_at'] ?? null?>"
                                        disabled>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="date" class="form-control" value="<?php echo $one_bill['due'] ?? null ?>"
                                        disabled>
                                </div>
                            </div>
                            <div class="form-group">
        ...
        <div class="row gutters-sm">
            <div class=" col-md-14 mb-3"><br>
                <div class="card border shadow-lg p-2">
                    ...
                    ?>
                                <tr style="text-align: center;">
                                    <td><?php echo $data['month'] ?? null; ?></td>
                                    <td><?php echo $data['pay_name'] ?? null; ?></td>
                                    <td><?php echo $data['pay_nic'] ?? null; ?></td>
                                    <td style="text-align: center;">
                                        <button class="btn btn-dark" data-bs-toggle="modal"
                                            data-bs-target="#<?php echo $data['token'] ?? null; ?>">View&nbsp;<i
                                                class="fa fa-file-text" aria-hidden="true"></i></button>

                                    </td>
                                    <div class="modal fade" id="<?php echo $data['token'] ?? null; ?>" tabindex="-1"
                                        aria-labelledby="<?php echo $data['token'] ?? null; ?>Label" aria-hidden="true">
                                        <div class="modal-dialog modal-lg modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header bg-danger">
                                                    <h4 class="modal-title" id="<?php echo $data['token'] ?? null; ?>Label"
                                                        style="color: white;">
                                                        Bill</h4>
                                                    ...
                                                    <div class="px-3 needs-validation">
                                                        <div class="form-row">
                                                            <div class="form-group col-md-2"><img
                                                                    src="../../images/ebd-logo.jpeg"></div>
                                                            <div class="form-group col-md-12 p-2">
                                                                <h5 style="text-align: center;">Bangladesh Electricity
                                                        ...
                                                        <div class="form-group">
                                                            <label>Name</label>
                                                            <input type="text" class="form-control"
                                                                value="<?php echo $data_method['name'] ?? null ?>" disabled>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Address</label>
                                                            <input type="text" class="form-control"
                                                                value="<?php echo $data_method['user_address'] ?? null ?>"
                                                                disabled>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Electricity Account Number</label>
                                                            <input type="text" class="form-control"
                                                                value="<?php echo $data_method['user_account'] ?? null ?>"
                                                                disabled>
                                                        </div>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                <label>Meter Reading</label>
                                                                <input type="text" class="form-control"
                                                                    value="<?php echo $one_bill['meter'] ?? null ?>" disabled>
                                                            </div>
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                <label>Units Consumed for Month
                                                                    <?php echo date('F')?></label>
                                                                <input type="text" class="form-control"
                                                                    value="<?php echo $one_bill['units'] ?? null ?>" disabled>
                                                            </div>
                                                        </div>

                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                <label>Charge For the Month(BDT.)</label>
                                                                <input type="text" class="form-control"
                                                                    value="<?php echo $one_bill['charge'] ?? null ?>" disabled>
                                                            </div>

                                                            <div class="form-group col-md-6">
                                                                <label>Total Amount Due (BDT.)</label>
                                                                <input type="text" class="form-control"
                                                                    value="<?php echo $one_bill['total'] ?? null ?>" disabled>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                <label>Updated</label>
                                                                <input type="text" class="form-control"
                                                                    value="<?php echo $one_bill['updated_at'] ?? null ?>"
                                                                    disabled>
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="date" class="form-control"
                                                                    value="<?php echo $one_bill['due'] ?? null ?>" disabled>
                                                            </div>
                                                        </div>
                                    ...
                                    <td>
                                        <div class="btn btn-success"><?php echo $data['pay_amount'] ?? null ; ?></div>
                                    </td>
