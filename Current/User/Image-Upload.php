                                ...
                                ?>
                                    <tr>
                                        <td>
                                            ...
                                            <?php
                                            $img_month = $data_bill['month'] ?? null;
                                            ...
                                            echo $data_img_month['month'] ?? null; ?>
                                        </td>
                                        <td style="text-align: center;"><a href="Download.php?user_id=<?php echo urlencode($data_img_month['user_id'] ?? null); ?>&month=<?php echo urlencode($img_month); ?>"><?php $data_img_month['filename'] ?? null; ?><i class="fa fa-file-image-o"></i></a></td>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="px-3 needs-validation">
                                                            ...
                                                            <div class="form-group">
                                                                <label>Name</label>
                                                                <input type="text" class="form-control" value="<?php echo $dataDetails['name'] ?? null ?>" disabled>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Address</label>
                                                                <input type="text" class="form-control" value="<?php echo $dataDetails['user_address'] ?? null ?>" disabled>
                                                            </div>
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    <label>Electricity Account Number</label>
                                                                    <input type="text" class="form-control" value="<?php echo $dataDetails['user_account'] ?? null ?>" disabled>
                                                                </div>

                                                                <div class="form-group col-md-6">
                                                                    <label>Category</label>
                                                                    <input type="text" class="form-control" value="<?php echo $dataDetails['category'] ?? null ?>" disabled>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control" value="<?php echo $data_bill['meter'] ?? null ?>" disabled>
                                                                </div>

                                                                <div class="form-group col-md-6">
                                                                    <label>Units Consumed for Month
                                                                        <?php echo date('F') ?></label>
                                                                    <input type="text" class="form-control" value="<?php echo $data_bill['units'] ?? null ?>" disabled>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    <label>Charge For the
                                                                        Month(BDT.)</label>
                                                                    <input type="text" class="form-control" value="<?php echo $data_bill['charge'] ?? null ?>" disabled>
                                                                </div>

                                                                <div class="form-group col-md-6">
                                                                    <label>Total Amount Due (BDT.)</label>
                                                                    <input type="text" class="form-control" value="<?php echo $data_bill['total'] ?? null ?>" disabled>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    <label>Updated</label>
                                                                    <input type="text" class="form-control" value="<?php echo $data_bill['updated_at'] ?? null ?>" disabled>

                                                                </div>

                                                                <div class="form-group col-md-6">
                                                                    <label>Due Date</label>
                                                                    <input type="date" class="form-control" value="<?php echo $data_bill['due'] ?? null ?>" disabled>
                                                                </div>
                                                            </div>
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                ...
                                <table class="table">
                                    ...
                                    ?>
                                        <td><i class="fa fa-file-image-o" aria-hidden="true"></i>&nbsp;<?php echo $row['filename'] ?? null; ?></td>
                                        <td style="text-align: center;"><a href="Download.php?user_id=<?php echo urlencode($row['user_id'] ?? null); ?>&month=<?php echo urlencode($due_month) ?>"><?php $row['filename'] ?? null; ?><i class="fa fa-download"></i></a></td>
                                    <?php
                                    }
                                    ?>
                                </table>
