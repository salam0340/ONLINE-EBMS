                                        ...
                                        <div class="carousel-item active">
                                            <div class="align-items-center text-center">
                                                <p style="font-size: 18px;">Welcome to Electricity Bill Management System
                                                    with BPDB</p style="font-size: 18px;">
                                            </div>
                                            <img src="../../images/ebd-logo.jpeg" class="d-block w-100" alt="...">
                        ...
                        <div class="card border shadow-lg mb-3 p-2">
                            <div class="card-body align-items-center text-center">
                                ...
                                <h6 class="align-items-center text-center">Category:
                                    <?php echo $data_method['category'] ?? null; ?></h6>
                                <a href="#"><button class="btn btn-primary">Switch to
                        ...
                        <div class="col-md-14">
                            <div class="card border shadow-lg mb-3 p-2">
                                ...
                                if (mysqli_query($link, $sql)) {
                                    ...
                                    $status = $dataDetails['status'] ?? null;
                        ...
                        <div class="col-md-14">
                            <div class="card border shadow-lg mb-2 p-2">
                                <div class="card-body align-items-center text-center">
                                    ...
                                    if ($data_method['category'] ?? null == 'Domestic') {
                                    ?>
                                    ...
                                    <?php
                                    } else if ($data_method['category'] ?? null == 'Industrial 1') {
                                    ?>
                                                            ...
                                                            <table class="table table-striped table-hover" style="text-align: center;">
                                                                <thead style="font-weight: bold;">
                                                                    <tr>
                                                                        ...
                                                                        <th>Fixed<br>Charge<br>(BDT/month)
                                                                        </th>
                                                                        <th>Max<br>Demand<br>Charge<br>(BDT/kVA)
                                                                        </th>
                                                                    </tr>
                                                                </thead>
                                                                <tr>
                                    ...
                                    <?php
                                    } else if ($data_method['category'] ?? null == 'General Purpose 1') {
                                    ?>
                                    ...
                                    <?php
                                    } else if ($data_method['category'] ?? null == 'Hotel 1') {
                                    ?>
                                    ...
                                    <?php
                                    } else if ($data_method['category'] ?? null == 'Religious & Charity') {
                                    ?>
